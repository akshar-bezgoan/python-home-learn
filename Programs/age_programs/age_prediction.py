...
prediction_year = int(input( 'Enter the year you want to know your age in:'))
...
print ('11 = November') 
print ('12 = December') 	
prediction_month = int (input( 'Enter the month you want to know your age in:'))
if prediction_month > 12: print('Invalid Response'); exit()
if prediction_month < 0: print('Invalid Response'); exit()
DOB_year = int(input( 'Enter the year you were born in:' )) 
if DOB_year > 2020:print('Invalid Response'); exit()
DOB_month = int(input( 'Enter the month you were born in:'))
